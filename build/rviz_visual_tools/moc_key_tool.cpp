...
#include "../../src/rviz_visual_tools/src/key_tool.h"
...
const QMetaObject rviz_visual_tools::KeyTool::staticMetaObject = {
    { &rviz::Tool::staticMetaObject, qt_meta_stringdata_rviz_visual_tools__KeyTool.data,
      qt_meta_data_rviz_visual_tools__KeyTool,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *rviz_visual_tools::KeyTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz_visual_tools__KeyTool.stringdata0))
        return static_cast<void*>(const_cast< KeyTool*>(this));
