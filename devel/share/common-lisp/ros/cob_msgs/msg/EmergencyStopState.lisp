...
(cl:defmethod cl:initialize-instance :after ((m <EmergencyStopState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmergencyStopState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<EmergencyStopState> is deprecated: use cob_msgs-msg:EmergencyStopState instead.")))
...
(cl:defmethod emergency_button_stop-val ((m <EmergencyStopState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:emergency_button_stop-val is deprecated.  Use cob_msgs-msg:emergency_button_stop instead.")
...
(cl:defmethod scanner_stop-val ((m <EmergencyStopState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:scanner_stop-val is deprecated.  Use cob_msgs-msg:scanner_stop instead.")
  (scanner_stop m))

(cl:ensure-generic-function 'emergency_state-val :lambda-list '(m))
(cl:defmethod emergency_state-val ((m <EmergencyStopState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:emergency_state-val is deprecated.  Use cob_msgs-msg:emergency_state instead.")
  (emergency_state m))
