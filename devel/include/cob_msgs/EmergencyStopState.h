// Generated by gencpp from file cob_msgs/EmergencyStopState.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_EMERGENCYSTOPSTATE_H
#define COB_MSGS_MESSAGE_EMERGENCYSTOPSTATE_H
...
struct EmergencyStopState_
{
  ...
  typedef boost::shared_ptr< ::cob_msgs::EmergencyStopState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::EmergencyStopState_<ContainerAllocator> const> ConstPtr;

}; // struct EmergencyStopState_

typedef ::cob_msgs::EmergencyStopState_<std::allocator<void> > EmergencyStopState;

typedef boost::shared_ptr< ::cob_msgs::EmergencyStopState > EmergencyStopStatePtr;
typedef boost::shared_ptr< ::cob_msgs::EmergencyStopState const> EmergencyStopStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::EmergencyStopState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::EmergencyStopState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::EmergencyStopState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::EmergencyStopState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::EmergencyStopState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd857d7312ffc16f7ULL;
  static const uint64_t static_value2 = 0x5239036504e493e9ULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::EmergencyStopState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::EmergencyStopState_<ContainerAllocator>& v)
  {
...
#endif // COB_MSGS_MESSAGE_EMERGENCYSTOPSTATE_H
