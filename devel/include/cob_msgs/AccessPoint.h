// Generated by gencpp from file cob_msgs/AccessPoint.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_ACCESSPOINT_H
#define COB_MSGS_MESSAGE_ACCESSPOINT_H
...
struct AccessPoint_
{
  ...
  typedef boost::shared_ptr< ::cob_msgs::AccessPoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::AccessPoint_<ContainerAllocator> const> ConstPtr;

}; // struct AccessPoint_

typedef ::cob_msgs::AccessPoint_<std::allocator<void> > AccessPoint;

typedef boost::shared_ptr< ::cob_msgs::AccessPoint > AccessPointPtr;
typedef boost::shared_ptr< ::cob_msgs::AccessPoint const> AccessPointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::AccessPoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::AccessPoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::AccessPoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::AccessPoint_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::AccessPoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::AccessPoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::AccessPoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::AccessPoint_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::AccessPoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::AccessPoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x810217d9e35df31fULL;
  static const uint64_t static_value2 = 0xfb396ea5673d7d1bULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::AccessPoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::AccessPoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::AccessPoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::AccessPoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::AccessPoint_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // COB_MSGS_MESSAGE_ACCESSPOINT_H
